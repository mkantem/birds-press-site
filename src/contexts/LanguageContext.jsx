...
const translations = {
  ...
  fr: {
    ...
    'policies.peer': 'Politique d\'Évaluation par les Pairs',
    ...
    'policies.reviewer': 'Lignes Directrices pour les Évaluateurs',
    'policies.advertising': 'Politique de Publicité et de Marketing',
    ...
    'footer.copyright': '© 2026 Institut de Bamako. Tous droits réservés.',
